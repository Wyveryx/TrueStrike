------------------------------------------------------------------------
-- TrueStrike Battle Text - Constants
...
-- Expose shared namespace globally for macro/console access.
-- Required for /run diagnostics and external addon interop.
_G.TSBT = TSBT
